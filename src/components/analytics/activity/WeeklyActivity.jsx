...
const WeeeklyActivity=({activeTab})=>{
    ...
    },
    {
     ...
     const  weeklyActivity=async()=>{   
             ...
             const data={page:pageNumber,search:searchInput} 
                  const res=await dispatch(getAllActiveUser({token,key:"weekly",data})).unwrap();                  
              }catch(error){
             console.log(error);
    ...
    return(
        ...
        <div className="flex gap-2. py-2">
            <CustomCard data={activeUser?.totalpage} value={"Weekly Active Users (W A U)"} />
            </div>
...
export default WeeeklyActivity;
